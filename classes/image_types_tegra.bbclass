...
CONVERSION_DEPENDS_bup-payload = "tegra186-flashtools-native coreutils-native tegra-bootfiles tegra-redundant-boot nv-tegra-release dtc-native virtual/bootloader:do_deploy virtual/kernel:do_deploy ${BUP_DEPS_EXTRA}"
