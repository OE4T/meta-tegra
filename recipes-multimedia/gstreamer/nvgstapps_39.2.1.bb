...
require recipes-bsp/tegra-sources/tegra-sources-39.2.1.inc
...
RRECOMMENDS:nvgstipctestapp = "gstreamer1.0-plugins-nvipcpipeline gstreamer1.0-plugins-nvvideo4linux2"
