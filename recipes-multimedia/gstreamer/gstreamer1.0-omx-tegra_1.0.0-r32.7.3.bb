...
require recipes-bsp/tegra-sources/tegra-sources-32.7.3.inc
...
RDEPENDS_${PN} += "tegra-configs-omx-tegra gstreamer1.0-plugins-nveglgles-nveglglessink tegra-libraries-omx"
