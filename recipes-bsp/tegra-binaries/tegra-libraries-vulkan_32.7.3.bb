...
MAINSUM_tegra210 = "6928ebe44d8097622ef24e1c505fe45c69415ee2db8614ecffb11a35f5d0a343"
...
FILES_SOLIBSDEV = ""
SOLIBS = ".so*"
FILES_${PN} += "/usr/lib/aarch64-linux-gnu"
CONTAINER_CSV_FILES_append = "${@bb.utils.contains('DISTRO_FEATURES', 'x11', ' ${sysconfdir}/vulkan/icd.d/* /usr/lib/aarch64-linux-gnu/tegra/nvidia_icd.json', '', d)}"
