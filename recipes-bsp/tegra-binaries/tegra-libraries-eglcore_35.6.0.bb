...
TEGRA_LIBRARIES_TO_INSTALL = "\
    ...
    tegra/libnvidia-eglcore.so.35.5.0 \
    tegra/libnvidia-glsi.so.35.5.0 \
    tegra/libnvidia-glvkspirv.so.35.5.0 \
    tegra/libnvidia-rmapi-tegra.so.35.5.0 \
    tegra/libnvidia-rtcore.so.35.5.0 \
"
