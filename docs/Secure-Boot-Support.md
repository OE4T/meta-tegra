...
# Getting started
Start by reading the [Secure Boot](https://docs.nvidia.com/jetson/archives/r39.2/DeveloperGuide/SD/Security/SecureBoot.html) section of the Jetson Linux Developer's Guide.
